...
def open_application(text):
    if "google" in text:
        ...
        speak("Mở Excel")
        os.system("C:\Program Files (x86)\Microsoft Office\root\Office16\EXCEL.EXE")
    else:
...
def send_email(text):
    ...
    if "minh" in recipient:
        ...
        speak("BaoBao không hiểu bạn muốn gửi email cho ai  ...")
...
def main_brain():
    ...
    if name:
        ...
        speak(f'Bạn cần BaoBao giúp gì không ạ ?')
        while True:
            text = get_text()
